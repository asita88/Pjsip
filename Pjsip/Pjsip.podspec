...
s.homepage     = "https://github.com/sanyamjain65/Pjsip"
s.license      = "MIT"
s.author       = { "sanyam" => "sanyam.j65@gmail.com" }
s.platform     = :ios
s.ios.deployment_target = "11.0"
s.source       = { :git => "https://github.com/sanyamjain65/Pjsip.git", :tag => "1.0.0" }
s.source_files = "Pjsip/**/*"
s.static_framework = true
s.private_header_files = 'Pjsip/**/*.h'
